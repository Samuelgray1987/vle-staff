      ...
      <!--
       ...
       <div class="row">
        ...
        <table class="table table-inbox table-hover">
          <thead>
            <tr>
              <th class="text-center"><a href="" ng-click="reverse = predicate == 'class' && !reverse; predicate = 'class'">Class</a></th>
              <th class="text-center"><a href="" ng-click="reverse = predicate == 'staff_name' && !reverse; predicate = 'staff_name'">Staff Member</a></th>
              ...
              <th class="text-center"><i class="fa fa-check"> </i><a href="" ng-click="reverse = predicate == 'completed' && !reverse; predicate = 'completed'">Completed by <br>staff</a></th>
