...
<head>
	...
	<body>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
            		<li><a class="apps active" href="admin#/">Admin</a></li>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a ng-href="#/users-permissions-assign">Assign Permissions</a></li>
    ...
    <!-- Angular Project Includes -->
        ...
        <!-- Users Files -->
            <script src='<?= asset('./angular/app/users/index.js') ?>'></script>
            <script src='<?= asset('./angular/app/users/services/services.js') ?>'></script>
            <script src='<?= asset('./angular/app/users/controllers/users.js') ?>'></script>
            <script src='<?= asset('./angular/app/users/directives/directives.js') ?>'></script>	
            <script>
